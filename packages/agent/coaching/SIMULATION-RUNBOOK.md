...
The [dated acceptance record](../../../docs/14-enhancement-acceptance.md) tracks the current run. At its 10 September snapshot, V4 version `agtvrsn_3001m2411bwkehx99pfbqbky6jzj` is running all 17 variants three times on the validation branch. No provider pass, live deployment or actual voice-listening result is claimed yet.
