...
const opts = { conciergeUrl: process.env.CONCIERGE_PUBLIC_URL ?? "https://voxi-concierge.example.com", toolSecretHeader: { value: process.env.TOOL_HMAC_SECRET ?? "change-me-tool-secret" }, inlineTools: true };
